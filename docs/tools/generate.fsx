...
let website = "/SlackTypeProvider"

let githubLink = "http://github.com/rflechner/SlackTypeProvider"

// Specify more information about your project
let info =
  [ "project-name", "SlackTypeProvider"
    "project-author", "rflechner"
    "project-summary", "A tiny type provider to use Slack API"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/SlackTypeProvider" ]
